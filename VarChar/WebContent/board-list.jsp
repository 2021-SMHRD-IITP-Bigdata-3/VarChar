              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                   	  <th class="px-4 py-3" style="text-align: center">글 번호</th>
                      <th class="px-4 py-3" style="text-align: center">제목</th>
                      <th class="px-4 py-3" style="text-align: center">작성자</th>
                    </tr>
                  </thead>
                  <tbody
